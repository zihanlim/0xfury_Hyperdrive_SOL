...
interface SmartAccount5Interface extends ethers.utils.Interface {
  functions: {
    ...
    "encodeTransactionData((address,uint256,bytes,uint8,uint256),uint256,(uint256,uint256,uint256,address,address))": FunctionFragment;
    ...
    "getTransactionHash(address,uint256,bytes,uint8,uint256,uint256,uint256,uint256,uint256,address,address)": FunctionFragment;
...
export class SmartAccount5 extends BaseContract {
  ...
  interface: SmartAccount5Interface;
