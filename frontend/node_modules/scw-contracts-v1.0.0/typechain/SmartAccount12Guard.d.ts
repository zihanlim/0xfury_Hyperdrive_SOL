...
interface SmartAccount12GuardInterface extends ethers.utils.Interface {
  functions: {
  ...
  events: {
    ...
    "GuardChanged(address)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "GuardChanged"): EventFragment;
...
export type GuardChangedEvent = TypedEvent<[string] & { guard: string }>;
...
export class SmartAccount12Guard extends BaseContract {
  ...
  interface: SmartAccount12GuardInterface;
  ...
  functions: {
    ...
    getGuard(overrides?: CallOverrides): Promise<[string] & { guard: string }>;
  ...
  filters: {
    ...
    "GuardChanged(address)"(
      guard?: null
    ): TypedEventFilter<[string], { guard: string }>;

    GuardChanged(guard?: null): TypedEventFilter<[string], { guard: string }>;
