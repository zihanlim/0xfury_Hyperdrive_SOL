...
interface SmartAccount6Interface extends ethers.utils.Interface {
  functions: {
    ...
    "reinit(address)": FunctionFragment;
    ...
    "transferByFriend(address,uint256)": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "friend", values?: undefined): string;
  encodeFunctionData(
  ...
  encodeFunctionData(functionFragment: "reinit", values: [string]): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "transferByFriend",
    values: [string, BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "friend", data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: "reinit", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "requiredTxGas",
    data: BytesLike
  ): Result;
...
export class SmartAccount6 extends BaseContract {
  ...
  interface: SmartAccount6Interface;
  ...
  functions: {
    ...
    friend(overrides?: CallOverrides): Promise<[string]>;
  ...
  callStatic: {
    ...
    reinit(_friend: string, overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    friend(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    friend(overrides?: CallOverrides): Promise<PopulatedTransaction>;
