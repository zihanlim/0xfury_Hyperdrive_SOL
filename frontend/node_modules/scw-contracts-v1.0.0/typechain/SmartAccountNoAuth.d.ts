...
interface SmartAccountNoAuthInterface extends ethers.utils.Interface {
  functions: {
    ...
    "handlePayment(uint256,uint256,uint256,uint256,address,address)": FunctionFragment;
...
export class SmartAccountNoAuth extends BaseContract {
  ...
  interface: SmartAccountNoAuthInterface;
