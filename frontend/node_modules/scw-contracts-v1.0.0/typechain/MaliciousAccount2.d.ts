...
interface MaliciousAccount2Interface extends ethers.utils.Interface {
  functions: {
...
export class MaliciousAccount2 extends BaseContract {
  ...
  interface: MaliciousAccount2Interface;
