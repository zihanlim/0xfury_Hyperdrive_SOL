...
interface TestExpiryAccountInterface extends ethers.utils.Interface {
  functions: {
...
export class TestExpiryAccount extends BaseContract {
  ...
  functions: {
    ...
    ownerAfter(arg0: string, overrides?: CallOverrides): Promise<[number]>;

    ownerUntil(arg0: string, overrides?: CallOverrides): Promise<[number]>;
