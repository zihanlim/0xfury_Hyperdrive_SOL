...
interface SmartAccount7Interface extends ethers.utils.Interface {
  functions: {
    ...
    "isActiveModuleManager()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "isActiveModuleManager",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(functionFragment: "reinit", values: [boolean]): string;
  encodeFunctionData(
...
export class SmartAccount7 extends BaseContract {
  ...
  interface: SmartAccount7Interface;
  ...
  functions: {
    ...
    isActiveModuleManager(overrides?: CallOverrides): Promise<[boolean]>;
  ...
  callStatic: {
    ...
    reinit(_isMMActive: boolean, overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    isActiveModuleManager(overrides?: CallOverrides): Promise<BigNumber>;
