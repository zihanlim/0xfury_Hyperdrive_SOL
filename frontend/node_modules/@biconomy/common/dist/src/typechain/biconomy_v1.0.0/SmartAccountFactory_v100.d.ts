...
export interface SmartAccountFactory_v100Interface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "accountCreationCode" | "basicImplementation" | "deployAccount" | "deployCounterFactualAccount" | "getAddressForCounterFactualAccount" | "minimalHandler"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "deployAccount", values: [PromiseOrValue<string>]): string;
    encodeFunctionData(functionFragment: "deployCounterFactualAccount", values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>]): string;
    encodeFunctionData(functionFragment: "getAddressForCounterFactualAccount", values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>]): string;
...
export interface SmartAccountFactory_v100 extends BaseContract {
    ...
    functions: {
        ...
        deployAccount(_owner: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        deployCounterFactualAccount(_owner: PromiseOrValue<string>, _index: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        getAddressForCounterFactualAccount(_owner: PromiseOrValue<string>, _index: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[string] & {
            _account: string;
        }>;
    ...
    callStatic: {
        accountCreationCode(overrides?: CallOverrides): Promise<string>;
        basicImplementation(overrides?: CallOverrides): Promise<string>;
        deployAccount(_owner: PromiseOrValue<string>, overrides?: CallOverrides): Promise<string>;
        deployCounterFactualAccount(_owner: PromiseOrValue<string>, _index: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<string>;
        getAddressForCounterFactualAccount(_owner: PromiseOrValue<string>, _index: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<string>;
        minimalHandler(overrides?: CallOverrides): Promise<string>;
    };
    filters: {
        "AccountCreation(address,address,uint256)"(account?: PromiseOrValue<string> | null, owner?: PromiseOrValue<string> | null, index?: PromiseOrValue<BigNumberish> | null): AccountCreationEventFilter;
        AccountCreation(account?: PromiseOrValue<string> | null, owner?: PromiseOrValue<string> | null, index?: PromiseOrValue<BigNumberish> | null): AccountCreationEventFilter;
        "AccountCreationWithoutIndex(address,address)"(account?: PromiseOrValue<string> | null, owner?: PromiseOrValue<string> | null): AccountCreationWithoutIndexEventFilter;
        AccountCreationWithoutIndex(account?: PromiseOrValue<string> | null, owner?: PromiseOrValue<string> | null): AccountCreationWithoutIndexEventFilter;
    };
    estimateGas: {
        ...
        getAddressForCounterFactualAccount(_owner: PromiseOrValue<string>, _index: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        getAddressForCounterFactualAccount(_owner: PromiseOrValue<string>, _index: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
