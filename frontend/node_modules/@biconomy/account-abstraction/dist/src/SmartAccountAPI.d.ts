...
export declare class SmartAccountAPI extends BaseAccountAPI {
     ...
     */
    constructor(httpRpcClient: HttpRpcClient, provider: Provider, entryPoint: EntryPoint, clientConfig: ClientConfig, accountAddress: string | undefined, implementationAddress: string, owner: Signer, handlerAddress: string, factoryAddress: string, index?: number, overheads?: Partial<GasOverheads>);
    factory?: string;
    /**
