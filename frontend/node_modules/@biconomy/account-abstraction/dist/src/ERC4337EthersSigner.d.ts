...
export declare class ERC4337EthersSigner extends Signer {
    ...
    address?: string;
    sendTransaction(transaction: TransactionRequest, walletDeployOnly?: boolean, paymasterServiceData?: PaymasterServiceDataType, engine?: any): Promise<TransactionResponse>;
    sendTransactionBatch(transactions: TransactionRequest[], paymasterServiceData?: PaymasterServiceDataType, engine?: any): Promise<TransactionResponse>;
