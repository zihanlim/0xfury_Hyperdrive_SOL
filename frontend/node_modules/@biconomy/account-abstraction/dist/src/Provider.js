...
async function newProvider(originalProvider, config, originalSigner = originalProvider.getSigner(), walletAddress, implementationAddress, fallbackHandlerAddress, factoryAddress) {
    ...
    const smartWalletAPI = new SmartAccountAPI_1.SmartAccountAPI(httpRpcClient, originalProvider, entryPoint, config, walletAddress, implementationAddress, originalSigner, fallbackHandlerAddress, factoryAddress, 0);
