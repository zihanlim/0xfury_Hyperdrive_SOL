...
describe('SmartAccountAPI', async () => {
    ...
    before('init', async () => {
        ...
        httpRpcClient = new src_2.HttpRpcClient(clientConfig.bundlerUrl, clientConfig.entryPointAddress, clientConfig.chainId, clientConfig.dappAPIKey);
        const entryPointClass = contracts_1.EntryPoint__factory.connect(entryPoint.address, signer);
        api = new src_1.SmartAccountAPI(httpRpcClient, provider, // can do json rpc provider
