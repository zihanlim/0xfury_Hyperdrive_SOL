...
class ContractUtils {
    ...
    initializeContracts(signer, readProvider, walletInfo, chaininfo) {
        ...
        this.smartWalletContract[walletInfo.chainId][version] = (0, FetchContractsInfo_1.getSmartWalletContract)(version, this.ethAdapter[walletInfo.chainId], walletInfo.address);
        common_1.Logger.log('SmartAccount Address ', walletInfo.address);
