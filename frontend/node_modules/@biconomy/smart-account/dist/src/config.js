...
exports.DevelopmentConfig = exports.StagingConfig = exports.ProductionConfig = void 0;
...
exports.ProductionConfig = {
    ...
    supportedNetworksIds: [
        ...
        core_types_1.ChainId.BSC_MAINNET,
        core_types_1.ChainId.ARBITRUM_GOERLI_TESTNET,
        core_types_1.ChainId.ARBITRUM_ONE_MAINNET,
        core_types_1.ChainId.ARBITRUM_NOVA_MAINNET,
        core_types_1.ChainId.POLYGON_ZKEVM_TESTNET,
        core_types_1.ChainId.POLYGON_ZKEVM_MAINNET
    ],
    ...
    networkConfig: [
        ...
        {
            chainId: core_types_1.ChainId.BSC_MAINNET,
            providerUrl: 'https://bsc-dataseed1.binance.org'
        },
        {
            chainId: core_types_1.ChainId.ARBITRUM_GOERLI_TESTNET,
            providerUrl: 'https://goerli-rollup.arbitrum.io/rpc'
        },
        {
            chainId: core_types_1.ChainId.ARBITRUM_ONE_MAINNET,
            providerUrl: 'https://rpc.ankr.com/arbitrum'
        },
        {
            chainId: core_types_1.ChainId.ARBITRUM_NOVA_MAINNET,
            providerUrl: 'https://nova.arbitrum.io/rpc'
        },
        {
            chainId: core_types_1.ChainId.POLYGON_ZKEVM_TESTNET,
            providerUrl: 'https://rpc.public.zkevm-test.net'
        },
        {
            chainId: core_types_1.ChainId.POLYGON_ZKEVM_MAINNET,
